package com.jackniu.flink.shaded.asm5.org.objectweb.asm;
...
public class Type {
    ...
    public static Type getObjectType(String var0) {
        ...
        return new Type(var1[0] == 91?9:10, var1, 0, var1.length);
    }
    ...
    public static Type getType(Class var0) {
        return var0.isPrimitive()?(var0 == Integer.TYPE?INT_TYPE:(var0 == Void.TYPE?VOID_TYPE:(var0 == Boolean.TYPE?BOOLEAN_TYPE:(var0 == Byte.TYPE?BYTE_TYPE:(var0 == Character.TYPE?CHAR_TYPE:(var0 == Short.TYPE?SHORT_TYPE:(var0 == Double.TYPE?DOUBLE_TYPE:(var0 == Float.TYPE?FLOAT_TYPE:LONG_TYPE)))))))):getType(getDescriptor(var0));
    }
    ...
    private static Type a(char[] var0, int var1) {
        ...
        switch(var0[var1]) {
            ...
            case '[':
                ...
                if(var0[var1 + var2] == 76) {
                    ++var2;

                    while(var0[var1 + var2] != 59) {
                        ++var2;
                    }
                }
    ...
    public int getDimensions() {
        int var1;
        for(var1 = 1; this.b[this.c + var1] == 91; ++var1) {
            ;
        }
    ...
    static {
        ...
        System.out.println("Shaded ASM 5 : _clinit__ 方法 没有执行");
    }
