...
import com.jackniu.flink.types.IntValue;
 ...
 * In each superstep, it simply waits until it has received a {@link } from each head and will send back
 * an {@link } to signal that the next superstep can begin.
 */
