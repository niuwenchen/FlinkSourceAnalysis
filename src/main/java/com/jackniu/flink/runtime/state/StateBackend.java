 ...
 * 
 * <p>The <i>raw bytes storage</i> (through the {@link }) is the fundamental
 ...
 *
 * <p>The {@link } and {@link } created by this state
 ...
 * of {@link }) are meant to be like <i>factories</i> that create the proper
