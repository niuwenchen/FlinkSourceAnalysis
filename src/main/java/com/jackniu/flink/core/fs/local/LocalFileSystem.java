...
public class LocalFileSystem extends FileSystem {
	...
	@Override
	public FSDataOutputStream create(final Path filePath, final com.jackniu.flink.core.fs.FileSystem.WriteMode overwrite) throws IOException {
		checkNotNull(filePath, "filePath");

		if (exists(filePath) && overwrite == com.jackniu.flink.core.fs.FileSystem.WriteMode.NO_OVERWRITE) {
