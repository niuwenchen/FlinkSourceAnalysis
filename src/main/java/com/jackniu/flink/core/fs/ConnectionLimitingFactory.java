...
public class ConnectionLimitingFactory implements FileSystemFactory {
	...
	private ConnectionLimitingFactory(
			...
			LimitedConnectionsFileSystem.ConnectionLimitingSettings settings) {
	...
	public static FileSystemFactory decorateIfLimited(FileSystemFactory factory, String scheme, Configuration config) {
		...
		final LimitedConnectionsFileSystem.ConnectionLimitingSettings settings = LimitedConnectionsFileSystem.ConnectionLimitingSettings.fromConfig(config, scheme);
