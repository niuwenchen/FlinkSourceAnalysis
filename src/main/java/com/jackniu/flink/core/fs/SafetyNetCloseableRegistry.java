...
import com.jackniu.flink.util.AbstractCloseableRegistry;
import com.jackniu.flink.util.Preconditions;
import com.jackniu.flink.util.WrappingProxyUtil;
 ...
 *
 * <p>Phantom references are used to track when {@link }s of {@link Closeable} got
 * GC'ed. We ensure that the wrapped {@link Closeable} is properly closed to avoid resource leaks.
 *
 * <p>Other than that, it works like a normal {@link }.
 *
